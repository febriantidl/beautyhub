...
class BookingController extends Controller
{
    public function index(Request $request)
    {
        ...
        $counts = (object)[
            'pending'   => Booking::where('mua_id', $muaId)->where('status', 'pending')->count(),
            'confirmed' => Booking::where('mua_id', $muaId)->where('status', 'approved')->count(),
            'completed' => Booking::where('mua_id', $muaId)->where('status', 'completed')->count(),
        ];
    ...
    public function approve($id)
    {
        ...
        return back()->with('success', 'Booking disetujui dan QR berhasil dibuat');
    }
